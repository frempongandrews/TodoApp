...
var remove = document.getElementsByClassName("remove-icon")[0];
...
function removeTodoItem (e) {
    ...
    // var listItemClicked = (e.target.parentNode).parentNode;
    // if (listItemClicked) {
    //     console.log(listItemClicked.innerText);
    //     listItemClicked.style.display = "none";
    // }
    console.log(e);
}